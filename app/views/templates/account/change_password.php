		...
		<article class="listing">
	        ...
	        <div class="holder">
	        	...
	        	<form action="#" method="POST" id="js-form" class="js-process-form" enctype="multipart/form-data">
	        		...
	        		<p class="js-error js-error-password error-msg error_message hide">Please provide your current password</p>
	        		...
	        		<p class="js-error js-error-new-password error-msg error_message hide">Please provide your new password</p>
	        		...
	        		<p class="js-error js-error-confirm-new-password error-msg error_message hide">Please provide your confirm new password</p>

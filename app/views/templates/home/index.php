<div class="login-area">
	...
	<h1>Bug Tracker</h1>
	<p class="error_message <?php echo !!$error ? '' : 'hide'; ?>"><?php echo $error; ?></p>
	...
	<div class="js-forgot-password-area <?php echo !!$show ? '' : 'hide'; ?>">
		<p class="error_message <?php echo !!$forgot_error ? '' : 'hide'; ?>"><?php echo $forgot_error; ?></p>
		<?php if( $success == FALSE ) : ?>
			<form action="#" method="POST" class="js-process-form">
				<p class="email">
					...
					<span class="js-error js-error-email-forgot error-msg error_message hide">Please provide your email</span>
				</p>
				<input type="submit" name="submit" class="submit-button" value="Submit" />
			</form>
		<?php else : ?>
			<p class="success_message"><?php echo $forgot_success; ?></p>
		<?php endif; ?>
	</div>
</div>
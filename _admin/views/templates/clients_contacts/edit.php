<section class="main__content">
	<article class="main__editor">
		<h1 class="main__editor--heading"><a href="<?php echo DIRECTORY; ?>admin/clients/edit/<?php echo $_GET[ 'id' ]; ?>" class="back-button icon-arrow-left"></a>clients contacts Edit <a href="<?php echo DIRECTORY; ?>admin/clients_contacts/edit">+ add another</a></h1>

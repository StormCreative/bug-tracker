...
class build_clients extends base_build
{
    private $_builder;
    ...
    public function __Construct ( $db_name, $tablename )
    {
        ...
        $this->_build = new query_builder ( $db_name, "clients" );
    }

    public function put ()
    {
        $this->_build->create_table ( "clients" );
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE 'pegisis_clients'" );
...
$build = new build_clients ( $this->_db_name, "clients" );
$build->desc ();
